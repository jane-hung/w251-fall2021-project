...
# get data
sudo wget -P data/helmet https://w251-masknomask.s3.amazonaws.com/helmet.zip
sudo unzip -q data/helmet/helmet.zip -d data/helmet
sudo chmod go+rx data/helmet
sudo chmod go+rx test
sudo chmod go+rx train
